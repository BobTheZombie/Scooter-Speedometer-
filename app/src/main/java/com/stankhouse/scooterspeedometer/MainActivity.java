...
public class MainActivity extends Activity implements LocationListener {
    ...
    private class SpeedView extends View {
        ...
        private void showPolishedMenu(String title,String subtitle,String[] labels,String[] details,MenuHandler handler){
            ...
            TextView brand=new TextView(MainActivity.this);brand.setText("SCOOTER OS  /  "+title);brand.setTextColor(UiKit.CYAN);brand.setTextSize(18);brand.setTypeface(android.graphics.Typeface.DEFAULT_BOLD);brand.setLetterSpacing(.08f);panel.addView(brand,new LinearLayout.LayoutParams(-1,Math.round(35*density)));
            ...
            TextView footer=new TextView(MainActivity.this);footer.setText("SCOOTER SPEEDOMETER  •  OS 5.2");footer.setTextColor(Color.rgb(80,115,126));footer.setTextSize(10);footer.setGravity(android.view.Gravity.CENTER);footer.setLetterSpacing(.12f);panel.addView(footer,new LinearLayout.LayoutParams(-1,Math.round(30*density)));
        ...
        private void drawHud(Canvas c,float w,float h,float scale){
            ...
            paint.setStyle(Paint.Style.FILL);text(c,"SCOOTER",w*.035f,h*.025f,9f*scale,Color.rgb(145,180,190),Paint.Align.LEFT,true);text(c,"OS",w*.035f,h*.047f,18f*scale,accentColor(),Paint.Align.LEFT,true);text(c,"RIDE SYSTEM",w*.035f,h*.064f,7f*scale,Color.rgb(110,145,156),Paint.Align.LEFT,false);
