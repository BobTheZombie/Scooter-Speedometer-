...
public final class UiKit {
    ...
    public static void field(EditText field){field.setTextColor(TEXT);field.setHintTextColor(Color.rgb(126,153,164));field.setTextSize(16);field.setSingleLine(true);field.setMinHeight(dp(field.getContext(),56));field.setPadding(dp(field.getContext(),16),0,dp(field.getContext(),16),0);field.setBackgroundTintList(null);field.setBackground(rounded(field.getContext(),SURFACE,16,BORDER));}
